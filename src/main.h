...
static const int LAST_POW_BLOCK = 32000;
...
public:
    ...
    {
        // pope: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // pope: get transaction coin age
...
public:
    ...
    // pope: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // pope: two types of block: proof-of-work or proof-of-stake
    ...
    // pope: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // pope: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // pope: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // pope: block index flags
    enum  
    {
